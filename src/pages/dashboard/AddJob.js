...
//         <FormRow type='text' name='Job Location' value={jobLocation} handleChange={handleJobInput}/>
//         <FormRow type='text' name='Company' value={company} handleChange={handleJobInput}/>
//         <FormRowSelect type='text' name='jobLocation' value={jobLocation} handleChange={handleJobInput}/>
